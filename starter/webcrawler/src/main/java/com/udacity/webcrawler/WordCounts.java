...
final class WordCounts {
    ...
    static Map<String, Integer> sort(Map<String, Integer> wordCounts, int popularWordCount) {
        ...
        return wordCounts.entrySet()
                ...
                // I know that i could use Integer::sum for the merge function but this way it's easier for me to understand when I look back to this code later
                .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (countValue1, countValue2) -> countValue1+countValue2, LinkedHashMap::new));
    }
